...
}:
{
  ...
  sofka = {
    ...
    version = "0.28.0";
    src = fetchurl {
      url = "https://github.com/nklmilojevic/sofka/releases/download/v0.28.0/sofka-v0.28.0-x86_64-unknown-linux-gnu.tar.gz";
      sha256 = "sha256-E1ti86nO3HDavF226syjOiiLTHUrSsQRkQ7xb5hijns=";
    };
  };
  talosctl = {
    pname = "talosctl";
