...
}:
{
  ...
  sofka = {
    ...
    version = "0.28.3";
    src = fetchurl {
      url = "https://github.com/nklmilojevic/sofka/releases/download/v0.28.3/sofka-v0.28.3-x86_64-unknown-linux-gnu.tar.gz";
      sha256 = "sha256-xPLuNsMSXVACtEVBzBY2Aj11xJzjWMO77U5gux9rYes=";
    };
  };
  talosctl = {
    pname = "talosctl";
