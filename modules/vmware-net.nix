...
let
  ...
  # guests as resolver+router (the NAT gateway on vmnet8, the host adapter on vmnet1).
  dhcpdConf =
    {
      vmnet,
      net,
    ...
    ''
      ...
      subnet ${net}.0 netmask 255.255.255.0 {
      	...
      	default-lease-time 1800;
      	max-lease-time 7200;
      ${lib.optionalString (routers != null) ''
      ...
      host ${vmnet} {
      	...
      	option domain-name "";
      ${lib.optionalString (routers != null) ''	option routers 0.0.0.0;''}
      }
    '';
in
{
